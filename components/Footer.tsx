      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 sm:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/login" className="text-slate-400 hover:text-indigo-400">تسجيل الدخول</Link></li>
            <li><Link href="/register" className="text-slate-400 hover:text-indigo-400">إنشاء حساب</Link></li>
          </ul>
        </div>

        <div>
          <h4 className="text-white font-bold mb-3">تواصل معنا</h4>
          <p className="text-slate-400 text-sm">support@omarstore.com</p>
          <p className="text-slate-400 text-sm mt-1">+20 100 000 0000</p>
        </div>
      </div>
